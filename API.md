...
Returns **[Object][47]** a valid result wrapping the value.
...
- `value` **[any][46]** an invalid value
- `message` **[any][46]** an error message
- `path` **[Array][48]** a sequence of keys leading to the invalid value
  (optional, default `[]`)
...
Returns **[Object][47]** an invalid result wrapping the error.
...
- `errors` **[Array][48]** a list of error objects
...
Returns **[Object][47]** an invalid result wrapping the errors.
...
Returns **[Function][49]** a check function.
...
- `message` **[any][46]** an error message (optional, default
  `"is not a boolean"`)
...
- `message` **[any][46]** an error message (optional, default `"is not a date"`)
...
- `radix` **[number][50]** an integer representing the base used to parse the
  number
- `message` **[any][46]** an error message used when the string could not be
  parsed
