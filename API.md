...
Returns **[Object][45]** a valid result wrapping the value.
...
- `value` **[any][44]** an invalid value
- `message` **[any][44]** an error message
- `path` **[Array][46]** a sequence of keys leading to the invalid value
  (optional, default `[]`)
...
Returns **[Object][45]** an invalid result wrapping the error.
...
- `errors` **[Array][46]** a list of error objects
...
Returns **[Object][45]** an invalid result wrapping the errors.
...
Returns **[Function][47]** a check function.
...
- `message` **[any][44]** an error message (optional, default
  `"is not a boolean"`)
...
- `message` **[any][44]** an error message (optional, default `"is not a date"`)
...
- `radix` **[number][48]** an integer representing the base used to parse the
  number
- `message` **[any][44]** an error message used when the string could not be
  parsed
