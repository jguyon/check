...
Returns **[Object][56]** a valid result wrapping the value.
...
- `value` **[any][55]** an invalid value
- `message` **[any][55]** an error message
- `path` **[Array][57]** a sequence of keys leading to the invalid value
  (optional, default `[]`)
...
Returns **[Object][56]** an invalid result wrapping the error.
...
- `errors` **[Array][57]** a list of error objects
...
Returns **[Object][56]** an invalid result wrapping the errors.
...
Returns **[Function][58]** a check function.
...
- `message` **[any][55]** an error message (optional, default
  `"is not a boolean"`)
...
- `message` **[any][55]** an error message (optional, default `"is not a date"`)
...
- `radix` **[number][59]** an integer representing the base used to parse the
  number
- `message` **[any][55]** an error message used when the string could not be
  parsed
