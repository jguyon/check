...
Returns **[Object][86]** a valid result wrapping the value.
...
- `value` **[any][85]** an invalid value
- `message` **[any][85]** an error message
- `path` **[Array][87]** a sequence of keys leading to the invalid value
  (optional, default `[]`)
...
Returns **[Object][86]** an invalid result wrapping the error.
...
- `errors` **[Array][87]** a list of error objects
...
Returns **[Object][86]** an invalid result wrapping the errors.
...
- `predicate` **[Function][88]** a function returning a boolean
- `message` **[any][85]** an error message (optional, default `"is invalid"`)
...
Returns **[Function][88]** a check function.
...
- `transform` **[Function][88]** a function transforming a value into another
...
- `checks` **...[Function][88]** check functions to chain
...
- `checks` **...[Function][88]** check functions
...
- `message` **[any][85]** an error message (optional, default `"is required"`)
...
- `check` **[Function][88]** a check function
...
- `message` **[any][85]** an error message (optional, default
  `"is not a boolean"`)
...
- `message` **[any][85]** an error message (optional, default `"is not a date"`)
...
- `radix` **[number][89]** an integer representing the base used to parse the
  number
- `message` **[any][85]** an error message used when the string could not be
  parsed
...
- `regexp` **[RegExp][90]** a regular expression to test against
- `message` **[any][85]** an error message (optional, default `"is invalid"`)
