...
Returns **[Object][65]** a valid result wrapping the value.
...
- `value` **[any][64]** an invalid value
- `message` **[any][64]** an error message
- `path` **[Array][66]** a sequence of keys leading to the invalid value
  (optional, default `[]`)
...
Returns **[Object][65]** an invalid result wrapping the error.
...
- `errors` **[Array][66]** a list of error objects
...
Returns **[Object][65]** an invalid result wrapping the errors.
...
Returns **[Function][67]** a check function.
...
- `message` **[any][64]** an error message (optional, default
  `"is not a boolean"`)
...
- `message` **[any][64]** an error message (optional, default `"is not a date"`)
...
- `radix` **[number][68]** an integer representing the base used to parse the
  number
- `message` **[any][64]** an error message used when the string could not be
  parsed
